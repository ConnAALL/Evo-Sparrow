...
def ppo_lstm_rule_benchmark_core(PPO_MODEL_PATH: str,
                                 LSTM_MODEL_PATH: str,
                                 GAME_COUNT: int,
    ...
    This version is for the PPO vs. LSTM vs. Rule-based benchmark.
    """
    INPUT_SIZE = 37
    OUTPUT_SIZE = 6
...
if __name__ == "__main__":
    ...
    for round_num in range(SPLIT):
        ...
        with multiprocessing.Pool(processes=num_cores) as pool:
            round_results = pool.starmap(ppo_lstm_rule_benchmark_core, pool_args)
    ...
    output_filename = f"ppo_lstm_rule_mp_result_1750_1M.txt"
    with open(output_filename, mode="a") as f:
        f.write("P1 PPO  P2 LSTM  P3 Rule-Based (Multi-Processing)\n")
